...
public class EngFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_eng, container, false);
    ...
    void fillData(){
        ...
        StringRequest postRequest=new StringRequest(ServerApp.GET_ENG_CAT,new Response.Listener<String>() {
            @Override
