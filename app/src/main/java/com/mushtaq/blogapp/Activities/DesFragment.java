...
public class DesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View fragmentView = inflater.inflate(R.layout.fragment_des, container, false);
    ...
    void fillData(){
        ...
        StringRequest postRequest=new StringRequest(ServerApp.GET_DES_CAT,new Response.Listener<String>() {
            @Override
